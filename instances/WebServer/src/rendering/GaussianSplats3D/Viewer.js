    ...
    downloadSplatSceneToSplatBuffer(path, splatAlphaRemovalThreshold = 1, onProgress = undefined,
        ...
        try {
            if (format === SceneFormat.Splat) {
                // REPLACED with loadFromFileData
                ...
                return SplatLoader.loadFromFileData(path, splatAlphaRemovalThreshold, this.inMemoryCompressionLevel, optimizeSplatData);
            } else if (format === SceneFormat.KSplat) {
                // REPLACED with loadFromFileData
                //return KSplatLoader.loadFromURL(path, onProgress, progressiveBuild, onSectionBuilt);
                return KSplatLoader.loadFromFileData(path);
                ...
                return PlyLoader.loadFromFileData(path, splatAlphaRemovalThreshold, this.inMemoryCompressionLevel, optimizeSplatData, this.sphericalHarmonicsDegree);
            }
        } catch (e) {
